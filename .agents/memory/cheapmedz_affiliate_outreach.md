...
## PARTNER 1: GoodRx API / Publisher Program
**Contact:** goodrx.com/developer/apply (form submission)
**Alt contact:** ada@goodrx.com
**Program type:** API Partnership (CPA/CPS model)
**Commission:** Per coupon redemption
...
## PARTNER 2: Blink Health
**Contact:** Via FlexOffers.com or shopper.com (instant approval available)
**Apply at:** flexoffers.com → search "Blink Health"
**Program type:** Affiliate (5–10% per sale)
**Cookie duration:** Standard 30 days
**Note:** Can get instant approval through Shopper.com
...
**Note:** Apply through standard Amazon Associates. No special approval needed. Easy to get in — need 3 sales within first 6 months to stay active.
...
**Note:** Form-based application. They brand your discount cards with your logo.
