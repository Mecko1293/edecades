...
const DECADES = [
  ...
  { id: "1960s", emoji: "☮️", label: "1960s", tagline: "Peace, Love & Revolution", bg: "#00080f", accent: "#FF6347", colors: ["#FF6347","#4169E1","#FFFF00","#FF69B4","#90EE90","#c4784f"], colorNames: ["Tomato Red","Royal Blue","Psychedelic Yellow","Hot Pink","Lime","Tangerine"], fashion: ["Mini skirts","Mod geometric prints","Hippie tie-dye & bell-bottoms","Go-go boots"], inventions: ["ARPANET / Internet (1969)","Moon Landing Apollo 11 (1969)","Laser (1960)"], culture: ["Civil Rights Movement","Woodstock & counterculture","British Invasion","Space Race","Assassination of JFK"] },
  { id: "1970s", emoji: "🕺", label: "1970s", tagline: "Funk, Disco & Soul", bg: "#0f0800", accent: "#c4784f", colors: ["#c4784f","#8B4513","#DAA520","#556B2F","#CD853F","#2F1B00"], colorNames: ["Burnt Orange","Saddle Brown","Goldenrod","Olive","Peru","Dark Chocolate"], fashion: ["Bell-bottom pants","Platform shoes","Mood rings","Leisure suits"], inventions: ["Personal Computer (1975)","VCR (1971)","MRI Scanner (1977)"], culture: ["Disco fever","Watergate scandal","Punk rock emerges","Star Wars (1977)","Environmental movement"] },
  { id: "1980s", emoji: "🎮", label: "1980s", tagline: "Neon, Power & Pop", bg: "#0f000f", accent: "#FF00FF", colors: ["#FF00FF","#00FFFF","#c4784f","#FFFF00","#FF1493","#7B00FF"], colorNames: ["Hot Magenta","Electric Cyan","Neon Orange","Laser Yellow","Deep Pink","Ultraviolet"], fashion: ["Power shoulders","Leg warmers","Acid-wash jeans","Big hair & scrunchies"], inventions: ["IBM PC (1981)","CD Player (1982)","DNA Fingerprinting (1984)"], culture: ["MTV launches","Video games boom","Cold War tension","AIDS crisis","Reaganomics"] },
  { id: "1990s", emoji: "📼", label: "1990s", tagline: "Grunge, Hip-Hop & the Web", bg: "#000f05", accent: "#00FF7F", colors: ["#00FF7F","#8B008B","#d4956e","#1E90FF","#FF4500","#2F2F2F"], colorNames: ["Spring Green","Dark Magenta","Gold","Dodger Blue","Orange Red","Charcoal"], fashion: ["Grunge flannel shirts","Baggy jeans & Timberlands","Slip dresses","Frosted tips"], inventions: ["World Wide Web (1991)","DVD (1995)","Dolly the Sheep cloned (1996)"], culture: ["Rise of hip-hop","Grunge & Nirvana","Internet goes mainstream","Reality TV begins","Fall of the Berlin Wall"] },
  { id: "2000s", emoji: "📱", label: "2000s", tagline: "Y2K & the Digital Age", bg: "#000a0f", accent: "#00BFFF", colors: ["#00BFFF","#FF69B4","#C0C0C0","#7B68EE","#d4956e","#000000"], colorNames: ["Deep Sky Blue","Pink","Silver","Medium Slate","Gold","Black"], fashion: ["Low-rise jeans","Von Dutch trucker hats","Juicy Couture tracksuits","Flip phones as fashion"], inventions: ["iPod (2001)","Facebook (2004)","YouTube (2005)"], culture: ["9/11 changes everything","War on Terror","Reality TV explosion","Social media birth","Harry Potter mania"] },
