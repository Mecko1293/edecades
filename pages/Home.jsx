  ...
  return (
    <div style={{ minHeight: "100vh", background: "#1e2530", fontFamily: "'Segoe UI', sans-serif", color: "#fff" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 20px 60px" }}>
        ...
        <div style={{ borderRadius: 20, background: "#262f3d", border: "1px solid rgba(255,255,255,0.08)", padding: "28px", marginBottom: 20 }}>
        ...
        <div style={{ borderRadius: 20, background: "#262f3d", border: "1px solid rgba(255,255,255,0.08)", padding: "28px", marginBottom: 32 }}>
        ...
        <div style={{ textAlign: "center" }}>
          <a href="https://benevolent-decade-dive-now.base44.app" style={{ background: "linear-gradient(135deg, #d4956e, #c4784f)", color: "#fff", padding: "14px 32px", borderRadius: 50, fontWeight: 900, fontSize: 16, textDecoration: "none", display: "inline-block" }}>← Back to eDecades</a>
