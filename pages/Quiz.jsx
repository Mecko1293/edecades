...
const decadeResults = {
  "1920s": {
    ...
    emoji: "🥂",
    color: "#d4956e",
    bg: "linear-gradient(135deg, #252018 0%, #2e2418 100%)",
    glow: "rgba(212,149,110,0.35)",
  ...
  "1930s": {
    ...
    emoji: "🎬",
    color: "#b8a88a",
    bg: "linear-gradient(135deg, #1e2220 0%, #252a22 100%)",
    glow: "rgba(184,168,138,0.35)",
  ...
  "1940s": {
    ...
    emoji: "✌️",
    color: "#7a9abf",
    bg: "linear-gradient(135deg, #1a1e28 0%, #1e2430 100%)",
    glow: "rgba(122,154,191,0.35)",
  ...
  "1950s": {
    ...
    emoji: "🎸",
    color: "#d4788a",
    bg: "linear-gradient(135deg, #221c20 0%, #2a1e22 100%)",
    glow: "rgba(212,120,138,0.35)",
  ...
  "1960s": {
    ...
    emoji: "☮️",
    color: "#c4956e",
    bg: "linear-gradient(135deg, #20201a 0%, #282418 100%)",
    glow: "rgba(196,149,110,0.35)",
  ...
  "1980s": {
    ...
    emoji: "📺",
    color: "#b87ac4",
    bg: "linear-gradient(135deg, #1e1a22 0%, #241a2a 100%)",
    glow: "rgba(184,122,196,0.35)",
  ...
  "1990s": {
    ...
    emoji: "💾",
    color: "#7aaa8a",
    bg: "linear-gradient(135deg, #1a2018 0%, #1e2820 100%)",
    glow: "rgba(122,170,138,0.35)",
  ...
  "2000s": {
    ...
    emoji: "📱",
    color: "#7aaac4",
    bg: "linear-gradient(135deg, #181e24 0%, #1c2430 100%)",
    glow: "rgba(122,170,196,0.35)",
  ...
  "2010s": {
    ...
    emoji: "🤳",
    color: "#c47aa4",
    bg: "linear-gradient(135deg, #201820 0%, #281e26 100%)",
    glow: "rgba(196,122,164,0.35)",
  ...
  "2020s": {
    ...
    emoji: "🚀",
    color: "#8aaa7a",
    bg: "linear-gradient(135deg, #1a2018 0%, #1c2418 100%)",
    glow: "rgba(138,170,122,0.35)",
